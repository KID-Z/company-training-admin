<!--
 * @Author: your name
 * @Date: 2021-07-13 10:26:37
 * @LastEditTime: 2021-07-27 09:14:03
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/training/SignIn.vue
-->
<template>
  <div class="sign-in">
    ...
    <div class="table-content">
      <el-table :data="tableData" style="width: 100%" height="calc(100vh - 200px)" stripe>
