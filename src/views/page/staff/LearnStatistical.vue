 ...
 * @LastEditTime: 2021-07-13 16:55:29
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/StaffLearn.vue
-->

<template>
  <div class="learn-statistical">
    <div class="search-course">
      <Search width="150" placeholder="课程名称" />
    </div>
