<!--
 * @Author: your name
 * @Date: 2021-07-08 13:41:08
 * @LastEditTime: 2021-07-13 16:51:58
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/StaffCreditHour.vue
-->

<template>
  <div class="credit-hour-statistical">
    <div class="operation">
      <el-date-picker
        v-model="value1"
        type="daterange"
