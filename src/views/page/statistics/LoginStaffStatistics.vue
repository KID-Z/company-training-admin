<!--
 * @Author: your name
 * @Date: 2021-07-15 13:34:26
 * @LastEditTime: 2021-07-16 15:06:19
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/LoginTatistics.vue
-->

<template>
  <div class="login-tatistics">
    <div class="charts"><ChartsLine title="登录人数统计图" mark="人数" /></div>
    <template>
      <div class="operation">
        <el-date-picker
          v-model="value1"
      ...
      <div class="table-content">
        <el-table :data="tableData" style="width: 100%" height="calc(100vh - 630px)" stripe>
          ...
          <el-table-column label="操作"  fixed="right">
            <template slot-scope="scope">
              <el-button size="mini" @click="loginDetails(scope.$index, scope.row)"
                >查看详情</el-button
              >
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    loginDetails() {
      this.$router.push({ name: 'LoginStaffDetails' });
    },
  },
  components: {
    ChartsLine,
