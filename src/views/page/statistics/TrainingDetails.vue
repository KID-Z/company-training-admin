<!--
 * @Author: your name
 * @Date: 2021-07-15 14:04:40
 * @LastEditTime: 2021-07-15 15:36:50
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/TrainingDetails.vue
-->

<template>
  <div class="training-details">
    <div class="charts"><ChartsLine title="任务时间统计" mark="任务数" /></div>
    <template>
      <div class="operation">
        <el-date-picker
          v-model="value1"
