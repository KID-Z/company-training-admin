<!--
 * @Author: your name
 * @Date: 2021-07-15 14:42:59
 * @LastEditTime: 2021-07-15 15:29:50
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/DeptLearnStatistics.vue
-->

<template>
  <div class="dept-learn-statistics">
    <div class="operation">
      <Search width="150" placeholder="搜索部门名称" />
      <a-button
        type="primary"
   ...
   <div class="table-content">
      <el-table :data="tableData" style="width: 100%" height="calc(100vh - 205px)" stripe>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template>
            <el-button size="mini" @click="viewDetails('DeptCourse')">部门课程</el-button>
            <el-button size="mini" type="danger" @click="viewDetails('DeptStaff')">部门员工</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
