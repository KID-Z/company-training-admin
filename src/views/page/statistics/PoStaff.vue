<!--
 * @Author: your name
 * @Date: 2021-07-16 09:16:06
 * @LastEditTime: 2021-07-16 09:16:06
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/Postaff.vue
-->

<template>
  <div class="po-staff">
    <div class="charts"><ChartsLine title="登录人数统计" mark="员工" /></div>
    <template>
     <div class="operation">
      <Search width="150" placeholder="搜索任务名称" />
    </div>
      <div class="table-content">
        <el-table :data="tableData" style="width: 100%" height="calc(100vh - 190px)" stripe>
          ...
          <template>
            <el-button size="mini" @click="staffDetails">查看详情</el-button>
          </template>
        </el-table-column>
        </el-table>
      </div>
...
import ChartsLine from '@/views/page/statistics/ChartsLine.vue';
...
export default {
  ...
  methods: {
    staffDetails() {
      this.$router.push({ name: 'PoStaffDetails' });
    },
  },
  components: {
    ChartsLine,
