<!--
 * @Author: your name
 * @Date: 2021-07-15 15:01:53
 * @LastEditTime: 2021-07-27 09:15:31
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/DeptStaffDetails.vue
-->

<template>
  <div class="dept-staff-details">
    <div class="table-container">
      <div class="search-staff">
        <Search width="170" placeholder="搜索姓名、手机号码" />
        <Cascader placeholder="岗位" />
        <Cascader placeholder="部门" />
      </div>
      <div class="table-content">
        <el-table :data="tableData" style="width: 100%" height="calc(100vh - 185px)" stripe>
