<!--
 * @Author: your name
 * @Date: 2021-07-15 14:56:03
 * @LastEditTime: 2021-07-15 14:58:32
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/DeptCourse.vue
-->

<template>
  <div class="dept-course">
    <div class="operation">
      <Search width="150" placeholder="搜索课程名称" />
    </div>
