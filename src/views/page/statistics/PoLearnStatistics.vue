<!--
 * @Author: your name
 * @Date: 2021-07-16 09:05:00
 * @LastEditTime: 2021-07-16 09:25:53
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/PoLearnStatistics.vue
-->

<template>
  <div class="po-learn-statistics">
    <div class="operation">
   ...
   <div class="table-content">
      <el-table :data="tableData" style="width: 100%" height="calc(100vh - 205px)" stripe>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template>
            <el-button size="mini" @click="viewDetails('PoCourse')">岗位课程</el-button>
            <el-button size="mini" type="danger" @click="viewDetails('PoStaff')">岗位员工</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
