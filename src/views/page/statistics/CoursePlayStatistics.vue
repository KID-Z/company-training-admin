<!--
 * @Author: your name
 * @Date: 2021-07-15 13:54:14
 * @LastEditTime: 2021-07-15 15:28:09
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/CoursePlayStatistics.vue
-->

<template>
  <div class="course-play-statistics">
    <div class="charts">
      <ChartsLine title="课程播放走势统计" mark="播放数" />
    </div>
    <template>
      <div class="operation">
        <el-date-picker
