<!--
 * @Author: your name
 * @Date: 2021-07-15 14:04:04
 * @LastEditTime: 2021-07-15 15:35:29
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /company-training-admin/src/views/page/statistics/TrainingTimeStatistics.vue
-->

<template>
  <div class="training-time-statistics">
    <div class="charts"><ChartsLine title="培训时间统计" mark="培训数" /></div>
    <template>
      <div class="operation">
        <el-date-picker
          v-model="value1"
      ...
      <div class="table-content">
        <el-table :data="tableData" style="width: 100%" height="calc(100vh - 190px)" stripe>
          ...
          <el-table-column label="状态">
            ...
            <template slot-scope="scope">
              <el-button size="mini" @click="trainingDetails(scope.$index, scope.row)"
                >查看详情</el-button
              >
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    trainingDetails() {
      this.$router.push({ name: 'TrainingDetails' });
    },
  },
  components: {
    ChartsLine,
